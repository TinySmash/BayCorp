    ...
    <>
      ...
      <div className="container">
        ...
        <p>
          ...
          vous utilisez notre service, mais nous comprenons que ce n&apos;est
          pas facile pour tout le monde. Si vous n&apos;êtes pas satisfait de
          votre achat ou si vous rencontrez un problème que nous ne pouvons pas
          résoudre et qui rend le système inutilisable, nous serons plus
          qu&apos;heureux de vous rembourser.
        </p>
        ...
        <p>
          ...
          de vous fournir de l&apos;aide. Si nous ne parvenons pas à résoudre
          votre problème dans les 48 heures, nous vous rembourserons. Veuillez
          contacter notre assistance en direct 24h/24 et 7j/7 à tout moment si
          vous besoin d&apos;assistance. Les remboursements ne peuvent être
          effectués que dans les 7 jours suivant la date d&apos;achat. Après 7
          jours, les remboursements ne pourront pas être traités. Si vous avez
          payé par carte de crédit, les remboursements sont généralement traités
          et les fonds reversés sur la carte de débit du client. compte bancaire
          dans les 20 à 31 jours ouvrables. Cependant, il existe des cas où le
          ...
          fonction de la durée d&apos;abonnement utilisée. L&apos;équipe
          d&apos;assistance contactera les utilisateurs dans tous les cas cas de
          remboursement. Remarque : Chaque remboursement prend généralement
          entre 20 et 90 jours ouvrables et il ne nous appartient pas de réduire
          ce délai. Remboursement les demandes seront traitées par nos
          processeurs de paiement. Nous ferons de notre mieux pour rembourser
          les utilisateurs immédiatement après voir la demande et vérifier les
        ...
        <div className="alert">
          ...
          <p>
            ...
            cause de diverses raisons. raisons, mais ce n&apos;est pas
            permanent. Nos ingénieurs experts travaillent toujours à leur
            réparation.
          </p>
          <h2>
          ...
          <ul>
            ...
            <li style={{ listStyle: "circle" }}>
              Le client a changé d&apos;avis et a voulu quitter/basculer entre
              les serveurs.
            </li>
          </ul>
          <p>
            Dans le cas où l&apos;utilisateur/client ne peut pas regarder son
            plan d&apos;abonnement IPTV pendant 48 heures ou plus en raison de
            problème de serveur ou d&apos;autres problèmes causés par nous, nous
            rembourserons intégralement le prix du forfait ou ajouterons tous
            les perdus du temps en plus de votre abonnement gratuitement, plus
            un bonus supplémentaire que nous pouvons négocier ensemble.
          </p>
